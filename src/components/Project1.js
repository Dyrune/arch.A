        ...
        entries.forEach((entry, index) => {
          if (entry.isIntersecting) {
            if (!entry.target.classList.contains("triggered")) {
              let animationClass = "slideFadeIn"; // Default fade-in from below

              // Determine animation class based on the element type
              ...
              // Set staggered delay for each element based on index
              const delay = `${index * 0.15}s`; // Staggered by 0.15s increments
              entry.target.style.animationDelay = delay;

              // Apply the animation class and mark as triggered
      ...
      <section className="project-section">
        <div className="project-content">
          ...
          <div className="project-description">
            <ul>
                <li className='fade-section'>Solitude</li>
                <li className='fade-section'>156mm to 3879mm</li>
                <li className='fade-section'>Futa, University</li>
                <li className='fade-section'>Dr. Prof jobadadan</li>
                <li className='fade-section'>Completed</li>
            </ul>
            <p className='fade-section'>This mixed media self-portrait contrast through the background with texture and shade. The smooth, colorful, person next to blank, textured, space; combined with all white hands.  </p>
          </div>
        </div>
      </section>
  ...
  className='fade-section'        alt="Inspiration 1" />
      ...
      <section className="planning-section">
        ...
        <div className="planning-row">
          ...
          className='fade-section'   onClick={() => handleImageClick("https://images.unsplash.com/photo-1728581665826-c1cf636d3652?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")}
         ...
         className='fade-section'    onClick={() => handleImageClick("https://images.unsplash.com/photo-1721044170058-1dc0e90bcec4?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")}
       ...
       className='fade-section'     onClick={() => handleImageClick("https://images.unsplash.com/photo-1699868943805-3a6b9e152366?q=80&w=1896&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")}
            ...
            className='fade-section'   alt="Planning Image 4" />
            ...
            className='fade-section'   alt="Planning Image 5" />
            ...
            className='fade-section'  alt="Planning Image 6" />
          </div>
        </div>
        ...
        <div className="planning-row" id='hgr'>
          <div className="planning-description fade-section">
            <p>
...
<section className="critique-section">
  ...
  <div className="critique-content">
    ...
    <div className="critique-row">
      <div className="critique-text slideFadeIn">
        <h3 className='fade-section'>Differences</h3>
        <ul>
          <li className='fade-section'>
          ...
          <li className='fade-section'>-Gainsborough work has a variety of hues in the background and on Siddons, while my own has a minimal color palette.</li>
        </ul>
      </div>
...
-Gainsborough's and my own painting are done in realism, focusing on correctly portraying a person.</li>
          <li className='fade-section'>-Both works are re-done paintings of someone. In my own piece I am repainting an old self-portrait and making it more true to life, and similarly Gainsborough is repainting a portrait of Sarah Siddons in her true light.</li>
          <li className='fade-section'>-In the two art works focus is put on the subject and who that person is: Siddons, a confidant person and me.</li>
        </ul>
      </div>
    </div>
  </div>
