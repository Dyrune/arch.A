      ...
      <section className="project-section">
        <div className="project-content">
          ...
          <div className="project-description">
            ...
            <p className="fade-right-section">This mixed media self-portrait contrast through the background with texture and shade. The smooth, colorful, person next to blank, textured, space; combined with all white hands.  </p>
          </div>
        </div>
      </section>
      ...
      <section className="inspiration-section">
        ...
        <div className="inspiration-row">
          <div className="inspiration-images">
            <img src="https://images.unsplash.com/photo-1730259692163-e2cf3d547aab?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"      className="fade-left-section"        onClick={() => handleImageClick("https://images.unsplash.com/photo-1730259692163-e2cf3d547aab?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")}
          alt="Inspiration 1" />
            <img src="https://images.unsplash.com/photo-1730170788262-152f85b25171?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"     className="fade-left-section"         onClick={() => handleImageClick("https://images.unsplash.com/photo-1730170788262-152f85b25171?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")}
          alt="Inspiration 2" />
          </div>
          <div className="inspiration-description">
            <p className="fade-right-section">My two artist inspirations was Auguste Rodin and Thomas Gainsborough. Rodin was a sculptor that made a multitude of works based on the human body, one being "Study of a Hand". Here Rodin used plaster to do a physical study a hand. There is rough and smooth qualities about the sculpture that advances the texture. Additionally the almost pained  
        ...
        <div className="inspiration-row" id='ir'>
          ...
          <div className="inspiration-description fade-section"><p>My two artist inspirations was Auguste Rodin and Thomas Gainsborough. Rodin was a sculptor that made a multitude of works based on the human body, one being "Study of a Hand". Here Rodin used plaster to do a physical study a hand. There is rough and smooth qualities about the sculpture that advances the texture. Additionally the almost pained  
            Gainsborough's painting is a rendition of another artist'sI</p>
         </div>
         
            <img src="https://images.unsplash.com/photo-1730170787479-ca21524efb7c?q=80&w=1907&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"             
        ...
        <div className="inspiration-row">
         ...
         className="fade-section"  alt="Inspiration Right" />
        </div>
      </section>
      ...
      <section className="planning-section">
        ...
        <div className="planning-row">
          <div className="planning-description">
            <p className='fade-left-section'>To plan I also took a reference photo to base my painting off of. I wanted to present myself with a static and blank face as not to allude to any emotions or thoughts. After increasing the contrast of the picture I added a grid over the my main reference so I could get my proportions and features correct. I then played around with how different backgrounds and different clothes might affect the overall feel of the work. I decided to continue with the solid dark clothes with contrasting white background to match the plaster hands.</p>
            <p className='fade-left-section'>To plan I also took a reference photo to base my painting off of. I wanted to present myself with a static and blank face as not to allude to any emotions or thoughts. After increasing the contrast of the picture I added a grid over the my main reference so I could get my proportions and features correct. I then played around with how different backgrounds and different clothes might affect the overall feel of the work. I decided to continue with the solid dark clothes with contrasting white background to match the plaster hands.</p>
            </div>
          <div className="planning-images-group">
            ...
            className='fade-right-section' alt="Planning Image 1" />
            ...
            className='fade-right-section'  alt="Planning Image 2" />
            ...
            className='fade-right-section'  alt="Planning Image 3" />
            ...
            className='fade-right-section'   alt="Planning Image 4" />
            ...
            className='fade-right-section'  alt="Planning Image 5" />
            ...
            className='fade-right-section'  alt="Planning Image 6" />
          </div>
        </div>
    ...
    <div className="critique-row">
      <div className="critique-text">
        ...
        <ul>
          ...
          <li className='fade-left-section'>-Gainsborough work has a variety of hues in the background and on Siddons, while my own has a minimal color palette.</li>
        </ul>
      </div>
      <div className="critique-image">
        <img src="https://plus.unsplash.com/premium_photo-1673014201324-2eccc35d8387?q=80&w=1789&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
         ...
         className='fade-right-section'  alt="Critique Image 1" />
      </div>
    </div>
    ...
    <div className="critique-row reverse">
      <div className="critique-image">
        <img src="https://plus.unsplash.com/premium_photo-1675615648106-7d7173bcda9f?q=80&w=2044&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
         ...
         className='fade-left-section'  alt="Critique Image 2" />
      </div>
      <div className="critique-text">
...
-Gainsborough's and my own painting are done in realism, focusing on correctly portraying a person.</li>
          <li className='fade-right-section'>-Both works are re-done paintings of someone. In my own piece I am repainting an old self-portrait and making it more true to life, and similarly Gainsborough is repainting a portrait of Sarah Siddons in her true light.</li>
          <li className='fade-right-section'>-In the two art works focus is put on the subject and who that person is: Siddons, a confidant person and me.</li>
        </ul>
      </div>
    </div>
  </div>
